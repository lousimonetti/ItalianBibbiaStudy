...
const MAP = new Map(Object.entries({
  ...
  // --- devotional texts (courses/<id>/devotions.js — the Prayers tab) ---
  // Every word in the prayers must gloss; glossCoverage.test.js guards it.
  onnipotente: 'almighty', creatore: 'Creator', unico: 'only/unique',
  concepito: 'conceived', vergine: 'Virgin', patì: 'suffered',
  ponzio: 'Pontius', pilato: 'Pilate', crocifisso: 'crucified',
  sepolto: 'buried', inferi: 'the underworld (hell)',
  risuscitò: 'rose again', siede: 'sits/is seated', destra: 'right hand',
  cattolica: 'Catholic',
  fatta: 'done/made', dacci: 'give us', quotidiano: 'daily',
  rimetti: 'forgive/remit', rimettiamo: 'we forgive/remit',
  debitori: 'debtors', indurre: 'to lead (into)', liberaci: 'deliver us',
  ave: 'hail', secoli: 'ages/centuries (nei secoli dei secoli = for ever and ever)',
  colpe: 'faults/sins', preservaci: 'preserve us/save us',
  inferno: 'hell', bisognose: 'in need',
  salve: 'hail', regina: 'queen', dolcezza: 'sweetness',
  ricorriamo: 'we turn (to)/have recourse', esuli: 'exiles/banished',
  eva: 'Eve', sospiriamo: 'we sigh', gementi: 'mourning/groaning',
  piangenti: 'weeping', orsù: 'come then/turn then',
  avvocata: 'advocate (f.)', rivolgi: 'turn (toward)',
  misericordiosi: 'merciful', mostraci: 'show us', esilio: 'exile',
  grembo: 'womb', clemente: 'clement/merciful', pia: 'loving/pious',
  dolce: 'sweet',
  guarda: 'look (upon)', propizio: 'favourably/propitious',
  intercessione: 'intercession', immacolata: 'immaculate',
  sposo: 'spouse/husband', esaudisci: 'grant/hear (a prayer)',
  benigno: 'kind/gracious', presentiamo: 'we present/offer',
  esaltazione: 'exaltation',
  michele: 'Michael', arcangelo: 'Archangel', difendici: 'defend us',
  lotta: 'battle/struggle', sii: 'be (imperative)',
  presidio: 'protection/safeguard', perfide: 'wicked/treacherous',
  insidie: 'snares', ordini: 'may (he) command/rebuke',
  supplichevolmente: 'humbly/beseechingly', imploriamo: 'we implore',
  principe: 'prince', milizia: 'host/army', ricaccia: 'thrust back',
  maligni: 'evil/malignant', perdizione: 'ruin/perdition',
  errando: 'wandering',
  proteggici: 'protect us', manto: 'mantle/cloak', guida: 'guide',
  sicura: 'sure/safe', incertezza: 'uncertainty', illumina: 'enlighten',
  menti: 'minds', sapienza: 'wisdom', momenti: 'moments', dubbio: 'doubt',
