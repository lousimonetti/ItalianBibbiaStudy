    ...
    weeks: [
      {
        ...
        vocab: [
          ['il Verbo', 'the Word', 'In principio era il Verbo', '/il ˈvɛrbo/'],
          ['la luce', 'the light', 'La luce splende', '/la ˈluːtʃe/'],
          ['le tenebre', 'the darkness', 'le tenebre non la vinsero', '/le ˈtɛːnebɾe/'],
          ['la vita', 'life', 'in lui era la vita', '/la ˈviːta/'],
          ['credere', 'to believe', 'ha creduto in lui', '/ˈkɾɛːdeɾe/'],
          ['il miracolo', 'the miracle', 'primo dei suoi miracoli', '/il miˈɾaːkolo/'],
          ['il mondo', 'the world', 'il mondo è stato fatto per mezzo di lui', '/il ˈmondo/'],
        ],
        grammar: {
      ...
      },
      {
        ...
        vocab: [
          ['nascere', 'to be born', 'bisogna nascere di nuovo', '/ˈnaʃʃeɾe/'],
          ['lo Spirito', 'the Spirit', 'lo Spirito soffia dove vuole', '/lo ˈspiːɾito/'],
          ['il pozzo', 'the well', 'sedeva presso il pozzo', '/il ˈpɔttso/'],
          ['adorare', 'to worship', 'i veri adoratori', '/adoˈɾaːɾe/'],
          ['il Salvatore', 'the Savior', 'il Salvatore del mondo', '/il salvaˈtoːɾe/'],
          ['credere', 'to believe', 'chi crede in lui', '/ˈkɾɛːdeɾe/'],
          ['il dono', 'the gift', 'se conoscessi il dono di Dio', '/il ˈdoːno/'],
        ],
        grammar: {
      ...
      },
      {
        ...
        vocab: [
          ['guarire', 'to heal', 'lo ha guarito', '/ɡwaˈɾiːɾe/'],
          ['il pane', 'bread', 'sono io il pane della vita', '/il ˈpaːne/'],
          ['la folla', 'the crowd', 'la folla grande lo seguiva', '/la ˈfɔlla/'],
          ['saziarsi', 'to be satisfied', 'mangiarono e si saziarono', '/sattsˈjaɾsi/'],
          ['la vita eterna', 'eternal life', 'ha la vita eterna', '/la ˈviːta eˈtɛɾna/'],
          ['la manna', 'manna', 'i nostri padri mangiarono la manna', '/la ˈmanna/'],
          ['il segno', 'the sign', 'quale segno fai tu?', '/il ˈseɲɲo/'],
        ],
        grammar: {
      ...
      },
      {
        ...
        vocab: [
          ['il cieco', 'blind man', 'un uomo cieco dalla nascita', '/il ˈtʃɛːko/'],
      ...
      },
      {
        ...
        vocab: [
          ['la vite', 'the vine', 'io sono la vite vera', '/la ˈviːte/'],
          ['il tralcio', 'the branch', 'ogni tralcio in me', '/il ˈtɾaltʃo/'],
          ['portare frutto', 'to bear fruit', 'portiate molto frutto', '/poɾˈtaːɾe ˈfɾutto/'],
          ['il comandamento', 'commandment', 'questo è il mio comandamento', '/il komandaˈmento/'],
          ['rimanere', 'to remain', 'rimanete nel mio amore', '/ɾimaˈnɛːɾe/'],
          ['il mondo', 'the world', 'il mondo vi odierà', '/il ˈmondo/'],
          ['la preghiera', 'prayer', 'pregò per i suoi discepoli', '/la pɾeˈɡjɛːɾa/'],
        ],
        grammar: {
      ...
      },
      {
        ...
        vocab: [
          ...
          ['la resurrezione', 'the resurrection', 'sono risorto', '/la ɾezuɾɾetˈtsjone/'],
          ['la missione', 'the mission', 'come il Padre ha mandato me', '/la misˈsjone/'],
          ['la pace', 'peace', 'la pace sia con voi', '/la ˈpaːtʃe/'],
        ],
        grammar: {
  ...
  },
  {
    ...
    weeks: [
      ...
      },
      {
        ...
        vocab: [
          ['il battesimo', 'baptism', 'il battesimo di Gesù', '/il batˈtɛːzimo/'],
          ['il deserto', 'desert', 'quaranta giorni nel deserto', '/il deˈzɛɾto/'],
          ['la tentazione', 'temptation', 'le tentazioni del diavolo', '/la tentaˈtsjone/'],
          ['la rete', 'net', 'gettate le reti', '/la ˈɾɛːte/'],
          ['il lebbroso', 'leper', 'un uomo pieno di lebbra', '/il lebˈbɾoːzo/'],
          ['perdonare', 'to forgive', 'ti sono perdonati i peccati', '/peɾdoˈnaːɾe/'],
          ['camminare', 'to walk', 'alzati e cammina', '/kammiˈnaːɾe/'],
        ],
        grammar: {
      ...
      },
      {
        ...
        vocab: [
          ['le beatitudini', 'the beatitudes', 'beati voi poveri', '/le beatituˈdiːni/'],
          ['il nemico', 'the enemy', 'amate i vostri nemici', '/il neˈmiːko/'],
          ['il centurione', 'centurion', 'il servo del centurione', '/il tʃentuˈɾjone/'],
          ['la vedova', 'widow', 'la vedova di Naim', '/la ˈvɛːdova/'],
          ['il fariseo', 'Pharisee', 'un fariseo lo invitò', '/il faɾiˈzɛːo/'],
          ['perdonare', 'to forgive', 'le sue peccata le sono perdonate', '/peɾdoˈnaːɾe/'],
          ['il profeta', 'the prophet', 'un grande profeta è sorto', '/il pɾoˈfɛːta/'],
        ],
        grammar: {
      ...
      },
      {
        ...
        vocab: [
          ['la tempesta', 'storm', 'calmò la tempesta', '/la temˈpɛsta/'],
          ['i demoni', 'demons', 'i demoni lo supplicavano', '/i ˈdɛːmoni/'],
          ['la fede', 'faith', 'la tua fede ti ha salvata', '/la ˈfɛːde/'],
          ['guarire', 'to heal', 'aveva guarito molti', '/ɡwaˈɾiːɾe/'],
          ['la trasfigurazione', 'transfiguration', 'la trasfigurazione sul monte', '/la tɾazfiɡuɾaˈtsjone/'],
          ['la croce', 'cross', 'prenda la sua croce', '/la ˈkɾoːtʃe/'],
          ['le provviste', 'provisions', 'non prendete nulla per il viaggio', '/le pɾovˈviste/'],
        ],
        grammar: {
      ...
      },
      {
        ...
        vocab: [
          ['la ricchezza', 'wealth', 'la vita non dipende dalla ricchezza', '/la ɾikˈkɛttsa/'],
          ['il granaio', 'granary', 'costruirò granai più grandi', '/il ɡɾaˈnaːjo/'],
      ...
      },
      {
        ...
        vocab: [
          ...
          ['abbracciare', 'to embrace', 'lo abbracciò e lo baciò', '/abbɾatˈtʃaːɾe/'],
          ['la festa', 'the celebration', 'facciamo festa', '/la ˈfɛsta/'],
        ],
        grammar: {
      ...
      },
      {
        ...
        vocab: [
          ...
          ['la fede', 'faith', 'la tua fede ti ha salvato', '/la ˈfɛːde/'],
          ['i bambini', 'children', 'lasciate che i bambini vengano', '/i bamˈbiːni/'],
        ],
        grammar: {
    ...
    weeks: [
      {
        ...
        vocab: [
          ...
          ['battezzarsi', 'to be baptized', 'battezzatevi', '/battedˈdzaɾsi/'],
          ['il peccato', 'sin', 'per la remissione dei peccati', '/il pekˈkaːto/'],
          ['la comunità', 'community', 'erano assidui nella comunione', '/la komuniˈta/'],
        ],
        grammar: {
      ...
      },
      {
        ...
        vocab: [
          ['la guarigione', 'healing', 'la guarigione dello storpio', '/la ɡwaɾiˈdʒone/'],
          ['la prigione', 'prison', 'li gettarono in prigione', '/la pɾiˈdʒone/'],
          ['Anania', 'Ananias', 'Anania con Saffira sua moglie', '/aˈnaːnja/'],
          ['mentire', 'to lie', 'hai mentito allo Spirito Santo', '/menˈtiːɾe/'],
          ['i diaconi', 'deacons', 'scelsero sette uomini', '/i ˈdjaːkoni/'],
          ['Stefano', 'Stephen', 'Stefano era pieno di grazia', '/ˈstɛːfano/'],
          ['la persecuzione', 'persecution', 'scoppiò una grande persecuzione', '/la peɾsekutˈtsjone/'],
        ],
        grammar: {
      ...
      },
      {
        ...
        vocab: [
          ['il martirio', 'martyrdom', 'la morte di Stefano', '/il maɾˈtiːɾjo/'],
          ['la lapidazione', 'stoning', 'lo lapidavano', '/la lapidaˈtsjone/'],
          ['Saulo', 'Saul', 'Saulo approvava la sua uccisione', '/ˈsaulo/'],
          ['la conversione', 'conversion', 'la conversione di Paolo', '/la konveɾˈsjone/'],
          ['la via di Damasco', 'road to Damascus', 'sulla via di Damasco', '/la ˈviːa di daˈmasko/'],
          ['cieco', 'blind', 'per tre giorni non vide nulla', '/ˈtʃɛːko/'],
          ['il battesimo', 'baptism', 'fu battezzato', '/il batˈtɛːzimo/'],
        ],
        grammar: {
      ...
      },
      {
        ...
        vocab: [
          ['la visione', 'vision', 'Pietro ebbe una visione', '/la viˈzjone/'],
      ...
      },
      {
        ...
        vocab: [
          ['il viaggio missionario', 'missionary journey', 'il primo viaggio', '/il ˈvjaddʒo missjoˈnaːɾjo/'],
          ['Barnaba', 'Barnabas', 'Barnaba e Paolo', '/ˈbaɾnaba/'],
          ['la sinagoga', 'synagogue', 'entrarono nella sinagoga', '/la sinaˈɡɔːɡa/'],
          ['il concilio', 'council', 'il concilio di Gerusalemme', '/il konˈtʃiːljo/'],
          ['la circoncisione', 'circumcision', 'la questione della circoncisione', '/la tʃiɾkontʃiˈzjone/'],
          ['la grazia', 'grace', 'vivere nella grazia di Dio', '/la ˈɡɾattsja/'],
          ['annunciare', 'to announce', 'annunciarono la parola di Dio', '/annuntˈtʃaːɾe/'],
        ],
        grammar: {
      ...
      },
      {
        ...
        vocab: [
          ['Lidia', 'Lydia', 'Lidia apriva il cuore', '/ˈliːdja/'],
      ...
      },
      {
        ...
        vocab: [
          ...
          ['lo Spirito', 'the Spirit', 'lo Spirito Santo mi attesta', '/lo ˈspiːɾito/'],
        ],
        grammar: {
      ...
      },
      {
        ...
        vocab: [
          ['la difesa', 'defense', 'la difesa di Paolo', '/la diˈfeːza/'],
          ['il sinedrio', 'Sanhedrin', 'davanti al sinedrio', '/il siˈnɛːdɾjo/'],
          ['la congiura', 'conspiracy', 'una congiura contro Paolo', '/la konˈdʒuːɾa/'],
      ...
      },
      {
        ...
        vocab: [
          ...
          ['la grazia', 'grace', 'grazie alla grazia di Dio', '/la ˈɡɾattsja/'],
        ],
        grammar: {
  ...
  },
  {
    ...
    weeks: [
      ...
      },
      {
        ...
        vocab: [
          ['la fede', 'faith', 'giustificati per fede', '/la ˈfɛːde/'],
      ...
      },
      {
        ...
        vocab: [
          ['la pace', 'peace', 'abbiamo pace con Dio', '/la ˈpaːtʃe/'],
          ['la sofferenza', 'suffering', 'glorificarci nelle sofferenze', '/la soffeˈɾɛntsa/'],
          ['la speranza', 'hope', 'la speranza non delude', '/la speˈɾantsa/'],
          ['il rifugio', 'refuge', 'Dio è il nostro rifugio', '/il ɾiˈfuːdʒo/'],
          ['la forza', 'strength', 'la nostra forza', '/la ˈfoɾtsa/'],
          ['il battesimo', 'baptism', 'siamo stati battezzati in Cristo', '/il batˈtɛːzimo/'],
          ['la morte', 'death', 'morti al peccato', '/la ˈmɔɾte/'],
        ],
        grammar: {
      ...
      },
      {
        ...
        vocab: [
          ['la carne', 'flesh', 'la legge della carne', '/la ˈkaɾne/'],
          ['la condanna', 'condemnation', 'nessuna condanna per quelli in Cristo', '/la konˈdanna/'],
          ['la figliolanza', 'sonship', 'lo spirito di adozione filiale', '/la fiʎʎoˈlantsa/'],
          ['la creazione', 'creation', 'tutta la creazione geme', '/la kɾeaˈtsjone/'],
          ['la misericordia', 'mercy', 'abbi pietà di me', '/la mizeɾiˈkɔɾdja/'],
          ['il cuore', 'heart', 'crea in me un cuore puro', '/il ˈkwɔːɾe/'],
          ['il peccato', 'sin', 'mondami dalla mia colpa', '/il pekˈkaːto/'],
        ],
        grammar: {
      ...
      },
      {
        ...
        vocab: [
          ...
          ['il nome del Signore', 'name of the Lord', 'chiunque invoca il nome del Signore', '/il ˈnoːme del siˈɲɲoːɾe/'],
          ['essere salvato', 'to be saved', 'sarà salvato', '/ˈɛsseɾe salˈvaːto/'],
          ['il messaggero', 'messenger', 'come udranno senza un messaggero?', '/il messadˈdʒɛːɾo/'],
        ],
        grammar: {
      ...
      },
      {
        ...
        vocab: [
          ['il mistero', 'mystery', 'il mistero di Israele', '/il misˈtɛːɾo/'],
          ['il corpo di Cristo', 'body of Christ', 'un solo corpo in Cristo', '/il ˈkɔɾpo di ˈkɾisto/'],
          ['i doni', 'gifts', 'doni diversi secondo la grazia', '/i ˈdoːni/'],
          ['la Parola', 'the Word', 'la tua Parola è una lampada', '/la paˈɾɔːla/'],
          ['il sentiero', 'path', 'luce sul mio sentiero', '/il senˈtjɛːɾo/'],
          ['offrire', 'to offer', 'offrite i vostri corpi come sacrificio', '/ofˈfɾiːɾe/'],
          ['rinnovarsi', 'to be renewed', 'rinnovatevi nella mente', '/ɾinnoˈvaɾsi/'],
        ],
        grammar: {
      ...
      },
      {
        ...
        vocab: [
          ...
          ['vegliare', 'to watch over', 'non si assopisce, non dorme', '/veʎˈʎaːɾe/'],
          ['il custode', 'guardian', 'il Signore è il tuo custode', '/il kusˈtoːde/'],
          ['il viaggio', 'journey', 'il Signore protegge la tua vita', '/il ˈvjaddʒo/'],
        ],
        grammar: {
      ...
      },
      {
        ...
        vocab: [
          ...
          ['fuggire', 'to flee', 'dove fuggirò dalla tua presenza?', '/fudˈdʒiːɾe/'],
          ['meraviglioso', 'wonderful', 'meravigliose sono le tue opere', '/meɾaviʎˈʎoːzo/'],
        ],
        grammar: {
      ...
      },
      {
        ...
        vocab: [
          ...
          ['la fine', 'the end', 'sei arrivato alla fine', '/la ˈfiːne/'],
        ],
        grammar: {
