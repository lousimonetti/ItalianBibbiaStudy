...
- **Native iOS app: BUILT — lives in `ios-native/` (the `plan-ios-swift.md`
  ...
  helpers, vocabIndex, it2en common-word glosses, syncSnapshot) with an XCTest suite whose fixtures are
...
npm test             # vitest run — 588 tests across 53 files, all green
...
- **Tests:** `npm test` runs **588 vitest tests across 53 files**, all passing.
